...
class ProductRewardRelationManager extends BaseRelationManager
{
    ...
    {
        return __('lunar-rewards::reward.relationmanagers.rewards.title');
    }
    ...
    public function getDefaultTable(Table $table): Table
    {
        ...
        return $table
            ->heading(
                __('lunar-rewards::reward.relationmanagers.rewards.title')
            )
            ->description(
                __('lunar-rewards::reward.relationmanagers.rewards.description')
            )
            ->paginated(false)
            ->modifyQueryUsing(
            ...
            ->headerActions([
                Tables\Actions\CreateAction::make()->form([
                    ...
                    __('lunar-rewards::reward.relationmanagers.rewards.actions.attach.label')
                ...
                Tables\Columns\TextColumn::make('purchasable.attribute_data.name')
                    ->label(
                        __('lunar-rewards::reward.relationmanagers.rewards.table.name.label')
                    )
                    ->formatStateUsing(
